        ...
        <section id="comic_info" class="container">
            ...
            <form action="{{route('comics.update', $comic->id)}}" method="POST">
                ...
                <div class="input-group my-3 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <input value="{{old('title', $comic->title)}}" type="text" class="form-control w-50 @error('title') is-invalid @enderror" id="title" name="title" placeholder="Una notte da leoni" required min="2" max="100">
                    @error('title')
                ...
                <div class="input-group my-4 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <input type="text" class="form-control w-50 @error('thumb') is-invalid @enderror" id="thumb" name="thumb" value="https://picsum.photos/seed/picsum/300/300" required>
                    @error('thumb')
                    <div class="invalid-feedback text-center">
                        {{$message}}
                    </div>
                ...
                <div class="input-group my-4 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <input type="text" class="form-control w-25 @error('price') is-invalid @enderror" id="price" name="price" placeholder="$4.99" required min="5" max="20" value="{{old('price', $comic->price)}}">
                    @error('price')
                    <div class="invalid-feedback text-center">
                        {{$message}}
                    </div>
                ...
                <div class="input-group my-4 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <input type="text" class="form-control w-25 @error('sale_date') is-invalid @enderror" id="sale_date" name="sale_date" placeholder="2020-01-07" required value="{{old('sale_date', $comic->sale_date)}}">
                    @error('sale_date')
                    <div class="invalid-feedback text-center">
                        {{$message}}
                    </div>
                ...
                <div class="input-group my-4 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <input type="text" class="form-control w-25 @error('series') is-invalid @enderror" id="series" name="series" placeholder="Marvel" required min="3" max="30" value="{{old('series', $comic->series)}}" >
                     @error('series')
                    <div class="invalid-feedback text-center">
                        {{$message}}
                    </div>
